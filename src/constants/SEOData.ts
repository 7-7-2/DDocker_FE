...
const routes = ROUTES.map(item => item.toLowerCase());
const SEO_DATA = {
  start: {
    title: '로그인',
    pageUrl: routes[0],
  ...
  follow: {
    title: '팔로워',
    pageUrl: routes[2],
    description: '나를 팔로우하는 똑커들을 확인하고 방문해보세요.'
  },
  following: {
    title: '팔로잉',
    pageUrl: routes[2],
    description: '내가 팔로우하는 똑커들의 프로필을 확인하고 방문해보세요.'
  },
  myPage: {
    title: '프로필 수정',
    pageUrl: routes[3],
    description:
      '똑커 계정의 프로필을 변경해보세요. 닉네임 변경, 프로필 사진 업로드, 한 줄 소개 등을 통해 나만의 프로필을 만들 수 있습니다.'
  },
  notification: {
    title: '알림',
    pageUrl: routes[4],
    description: '똑커 계정의 새로운 팔로우, 댓글, 종아요를 확인해보세요.'
  },
  post: {
    title: '게시물',
    pageUrl: `${routes[5]}`,
    description:
      '똑커 게시물의 브랜드, 메뉴, 카페인을 확인하고 좋아요, 댓글을 통해 소통해보세요. 똑커의 커피 사진과 게시글을 공유하기 버튼을 통해 공유해보세요.'
  },
  register: {
    title: '게시물 등록',
  ...
  update: {
    ...
    pageUrl: routes[5],
    description:
      '똑커 게시물의 정보를 잘못 입력하거나 수정하고 싶을 때 언제든지 게시물 정보를 변경 할 수 있습니다.'
  },
  postsTrend: {
    title: '트렌드 피드',
    pageUrl: routes[6],
  ...
  postsFollowing: {
    ...
    pageUrl: routes[6],
    description:
      '내가 팔로잉 하는 똑커 유저들의 촤신 게시물들을 확인하고 좋아요와 댓글을 남겨보세요.'
  },
  search: {
    title: '검색',
    pageUrl: routes[7],
    description:
      '검색을 통해 다른 똑커 유저를 검색헤보세요. 똑커 유저의 프로필에 방문해 게시물, 팔로우, 팔로잉 목록을 살펴 볼 수 있습니다.'
  },
  profile: {
    title: '프로필',
    pageUrl: routes[8],
    description: '똑커의 프로필을 확인하고 게시물을 둘러보세요'
  },
  coffee: {
    title: '나의 커피',
    pageUrl: routes[9],
  ...
  report: {
    ...
    pageUrl: routes[11],
    description:
      '신고 내용을 제출해주세요. 똑커 팀이 최대한 빠르게 검토하여 대응하겠습니다.'
  }
};
